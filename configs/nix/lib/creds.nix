...
in
{
  jade = {
    ...
    sshKeys = [
      ...
      "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBKNoqUVESW6PaKIEUfm7aXeAMbxZd33ahOEZGRfTWZyX5+BzV3a+hiOk0uD/ifHbmka3kGpaSX/qspj0kxNd4bQ= thinnerpad-touchid@secretive.thinnerpad.local"
    ];
  };
