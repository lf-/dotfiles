...
module Proto.Protos.Perfetto.Trace.Ftrace.Generic_Fields where
...
maybe'strValue ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'strValue" a) =>
  Lens.Family2.LensLike' f s a
maybe'strValue = Data.ProtoLens.Field.field @"maybe'strValue"
maybe'uintValue ::
  forall f s a.
  (Prelude.Functor f,
...
strValue ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "strValue" a) =>
  Lens.Family2.LensLike' f s a
strValue = Data.ProtoLens.Field.field @"strValue"
uintValue ::
  forall f s a.
  (Prelude.Functor f,
