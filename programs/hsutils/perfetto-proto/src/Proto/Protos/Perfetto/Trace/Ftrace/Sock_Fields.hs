...
module Proto.Protos.Perfetto.Trace.Ftrace.Sock_Fields where
...
maybe'family ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'family" a) =>
  Lens.Family2.LensLike' f s a
maybe'family = Data.ProtoLens.Field.field @"maybe'family"
maybe'newstate ::
  forall f s a.
  (Prelude.Functor f,
...
maybe'oldstate ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'oldstate" a) =>
  Lens.Family2.LensLike' f s a
maybe'oldstate = Data.ProtoLens.Field.field @"maybe'oldstate"
maybe'protocol ::
  forall f s a.
  (Prelude.Functor f,
...
oldstate ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "oldstate" a) =>
  Lens.Family2.LensLike' f s a
oldstate = Data.ProtoLens.Field.field @"oldstate"
protocol ::
  forall f s a.
  (Prelude.Functor f,
