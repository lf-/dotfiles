...
module Proto.Protos.Perfetto.Trace.Ftrace.Ipi_Fields where
...
maybe'targetCpus ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'targetCpus" a) =>
  Lens.Family2.LensLike' f s a
maybe'targetCpus = Data.ProtoLens.Field.field @"maybe'targetCpus"
reason ::
  forall f s a.
...
targetCpus ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "targetCpus" a) =>
  Lens.Family2.LensLike' f s a
targetCpus = Data.ProtoLens.Field.field @"targetCpus"