...
module Proto.Protos.Perfetto.Trace.Ftrace.DmabufHeap_Fields where
...
inode ::
  forall f s a.
  (Prelude.Functor f, Data.ProtoLens.Field.HasField s "inode" a) =>
  Lens.Family2.LensLike' f s a
inode = Data.ProtoLens.Field.field @"inode"
len ::
  forall f s a.
...
maybe'inode ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'inode" a) =>
  Lens.Family2.LensLike' f s a
maybe'inode = Data.ProtoLens.Field.field @"maybe'inode"
maybe'len ::
  forall f s a.
  (Prelude.Functor f,
