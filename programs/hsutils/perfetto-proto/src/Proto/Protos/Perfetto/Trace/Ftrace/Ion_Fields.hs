...
module Proto.Protos.Perfetto.Trace.Ftrace.Ion_Fields where
...
bufferId ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "bufferId" a) =>
  Lens.Family2.LensLike' f s a
bufferId = Data.ProtoLens.Field.field @"bufferId"
len ::
  forall f s a.
...
maybe'bufferId ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'bufferId" a) =>
  Lens.Family2.LensLike' f s a
maybe'bufferId = Data.ProtoLens.Field.field @"maybe'bufferId"
maybe'len ::
  forall f s a.
  (Prelude.Functor f,
