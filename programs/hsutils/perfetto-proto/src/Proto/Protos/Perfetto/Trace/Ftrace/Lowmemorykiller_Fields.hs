...
module Proto.Protos.Perfetto.Trace.Ftrace.Lowmemorykiller_Fields where
...
maybe'pagecacheLimit ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'pagecacheLimit" a) =>
  Lens.Family2.LensLike' f s a
maybe'pagecacheLimit
...
maybe'pagecacheSize ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'pagecacheSize" a) =>
  Lens.Family2.LensLike' f s a
maybe'pagecacheSize
...
pagecacheLimit ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "pagecacheLimit" a) =>
  Lens.Family2.LensLike' f s a
pagecacheLimit = Data.ProtoLens.Field.field @"pagecacheLimit"
pagecacheSize ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "pagecacheSize" a) =>
  Lens.Family2.LensLike' f s a
pagecacheSize = Data.ProtoLens.Field.field @"pagecacheSize"
pid ::
  forall f s a.
