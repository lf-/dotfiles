...
module Proto.Protos.Perfetto.Trace.TracePacketDefaults_Fields where
...
maybe'perfSampleDefaults ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'perfSampleDefaults" a) =>
...
maybe'trackEventDefaults ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'trackEventDefaults" a) =>
  Lens.Family2.LensLike' f s a
maybe'trackEventDefaults
...
perfSampleDefaults ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "perfSampleDefaults" a) =>
  Lens.Family2.LensLike' f s a
perfSampleDefaults
  = Data.ProtoLens.Field.field @"perfSampleDefaults"
timestampClockId ::
  forall f s a.
  (Prelude.Functor f,
...
trackEventDefaults ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "trackEventDefaults" a) =>
  Lens.Family2.LensLike' f s a
trackEventDefaults
  = Data.ProtoLens.Field.field @"trackEventDefaults"