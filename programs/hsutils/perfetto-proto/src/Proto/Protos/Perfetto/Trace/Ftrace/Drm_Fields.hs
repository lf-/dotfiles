...
module Proto.Protos.Perfetto.Trace.Ftrace.Drm_Fields where
...
highPrec ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "highPrec" a) =>
  Lens.Family2.LensLike' f s a
highPrec = Data.ProtoLens.Field.field @"highPrec"
maybe'crtc ::
  forall f s a.
  (Prelude.Functor f,
...
maybe'highPrec ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'highPrec" a) =>
  Lens.Family2.LensLike' f s a
maybe'highPrec = Data.ProtoLens.Field.field @"maybe'highPrec"
maybe'seq ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'seq" a) =>
  Lens.Family2.LensLike' f s a
maybe'seq = Data.ProtoLens.Field.field @"maybe'seq"
maybe'time ::
  forall f s a.
  (Prelude.Functor f,
