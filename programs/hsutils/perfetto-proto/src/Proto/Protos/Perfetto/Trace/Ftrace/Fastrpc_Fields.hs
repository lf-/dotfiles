...
module Proto.Protos.Perfetto.Trace.Ftrace.Fastrpc_Fields where
...
cid ::
  forall f s a.
  (Prelude.Functor f, Data.ProtoLens.Field.HasField s "cid" a) =>
  Lens.Family2.LensLike' f s a
cid = Data.ProtoLens.Field.field @"cid"
len ::
  forall f s a.
...
maybe'cid ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'cid" a) =>
  Lens.Family2.LensLike' f s a
maybe'cid = Data.ProtoLens.Field.field @"maybe'cid"
maybe'len ::
  forall f s a.
  (Prelude.Functor f,
