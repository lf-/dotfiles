...
module Proto.Protos.Perfetto.Trace.Ftrace.Lwis_Fields where
...
lwisName ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "lwisName" a) =>
  Lens.Family2.LensLike' f s a
lwisName = Data.ProtoLens.Field.field @"lwisName"
maybe'funcName ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'funcName" a) =>
  Lens.Family2.LensLike' f s a
maybe'funcName = Data.ProtoLens.Field.field @"maybe'funcName"
maybe'lwisName ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'lwisName" a) =>
  Lens.Family2.LensLike' f s a
maybe'lwisName = Data.ProtoLens.Field.field @"maybe'lwisName"
maybe'pid ::
  forall f s a.
  (Prelude.Functor f,
